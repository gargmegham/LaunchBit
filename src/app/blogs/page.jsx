                                ...
                                <div className="text-center">
                                    ...
                                    <div className="grid gap-6 md:grid-cols-2 max-w-5xl mx-auto">
                                        {[1, 2, 3, 4].map((index) => (
                                            <div
                                                key={index}
                                                className="bg-black/40 backdrop-blur-xl border border-white/40 rounded-3xl overflow-hidden animate-pulse"
                                            >
                                                <div className="h-40 bg-gradient-to-r from-white/50 via-amber-400/40 to-white/50"></div>
                                                <div className="p-6">
                                                    <div className="flex gap-2 mb-4">
                                                        <div className="w-12 h-4 bg-amber-400/40 rounded-full"></div>
                                                        <div className="w-16 h-4 bg-amber-400/40 rounded-full"></div>
                                                    </div>
                                                    <div className="w-4/50 h-6 bg-white/40 rounded mb-4"></div>
                                                    <div className="space-y-2 mb-4">
                                                        <div className="w-full h-3 bg-white/50 rounded"></div>
                                                        <div className="w-3/4 h-3 bg-white/50 rounded"></div>
                                                    </div>
                                                    <div className="flex justify-between items-center">
                                                        <div className="w-20 h-3 bg-white/50 rounded"></div>
                                                        <div className="w-16 h-4 bg-amber-400/40 rounded"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
