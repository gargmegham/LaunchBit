    ...
    return (
        <section id="faqs" className="relative mb-52 overflow-hidden flex items-center justify-center">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="flex-shrink-0">
                                    <div className={`w-8 h-8 rounded-full bg-gradient-to-br from-yellow-500 to-amber-500 flex items-center justify-center transform transition-transform duration-300 ${openFAQ === faq.id ? 'rotate-45' : ''}`}>
                ...
                <div className="mt-16 p-8 bg-gradient-to-br from-white/5 to-white/2 border border-white/10 rounded-xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            href="/#contact"
                            className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-amber-500 text-black font-semibold rounded-lg hover:from-yellow-400 hover:to-amber-400 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/25"
                        >
                            Contact Us
                        </a>
                        <a
                            ...
                            className="px-6 py-3 font-medium relative border-[1px] border-white/10 rounded-lg text-white bg-black hover:border-white/20 transition-all duration-200"
                        >
