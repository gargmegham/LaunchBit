        ...
        <section id="reviews" className="relative mb-52 overflow-hidden flex items-center justify-center">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
                ...
                <div className="relative overflow-hidden">
                    <div
                        className={`grid md:grid-cols-3 gap-6 max-w-6xl mx-auto transition-all duration-700 ease-in-out ${
                            isTransitioning
                    ...
                    >
                        {visibleReviews.map((review) => (
                            <div
                                ...
                                className={`group p-6 rounded-xl bg-gradient-to-br from-white/5 to-white/2 border border-white/10 hover:border-yellow-500/30 transition-all duration-300 text-left`}
                            >
                                <div className="mb-4">
                                    ...
                                    <p className="text-white/90 italic leading-relaxed text-left">"{review.text}"</p>
                                </div>
                                <div className="flex items-center">
                                    <div className="w-12 h-12 bg-gradient-to-br from-yellow-500 to-amber-500 rounded-full flex items-center justify-center mr-4">
                                    ...
                                    <div className="text-left">
                                        <p className="text-white font-semibold text-left">{review.author}</p>
